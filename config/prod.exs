...
config :mine, MineWeb.Endpoint,
  server: true,
  http: [port: 4000],
  # url: [scheme: "http", host: "mineapp-env.eba-nxjz2ubz.us-east-2.elasticbeanstalk.com/", port: {:system, "PORT"}],
  url: [host: "mineapp-env.eba-nxjz2ubz.us-east-2.elasticbeanstalk.com/"],
